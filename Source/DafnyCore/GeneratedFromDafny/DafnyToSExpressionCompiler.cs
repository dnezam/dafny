    ...
    public static Dafny.ISequence<Dafny.Rune> StatementToSexpr(DAST._IStatement stmt) {
      ...
      }
      {
        if (_source0.is_Print) {
          DAST._IExpression _27_expr = _source0.dtor_expr;
          DAST._IType _28_typ = _source0.dtor_typ;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Statement.Print"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_27_expr), DafnyToSExpressionCompiler.__default.TypeToSexpr(_28_typ)));
        }
      }
      {
        Dafny.ISequence<DAST._IField> _29_fields = _source0.dtor_fields;
        return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Statement.ConstructorNewSeparator"), DafnyToSExpressionCompiler.__default.MapJoin<DAST._IField>(Dafny.Helpers.Id<Func<Dafny.ISequence<DAST._IField>, Func<DAST._IField, Dafny.ISequence<Dafny.Rune>>>>((_30_fields) => ((System.Func<DAST._IField, Dafny.ISequence<Dafny.Rune>>)((_31_x) => {
          return DafnyToSExpressionCompiler.__default.FieldToSexpr(_31_x);
        })))(_29_fields), _29_fields)));
      }
    }
    ...
    public static Dafny.ISequence<Dafny.Rune> ExpressionToSexpr(DAST._IExpression expr) {
      ...
      }
      {
        if (_source0.is_UnOp) {
          ...
          DAST._IType _62_exprType_k = _source0.dtor_exprType;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.UnOp"), DafnyToSExpressionCompiler.__default.UnaryOpToSexpr(_60_unOp), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_61_expr_k), DafnyToSExpressionCompiler.__default.TypeToSexpr(_62_exprType_k)));
        }
      }
      {
        if (_source0.is_BinOp) {
          DAST._ITypedBinOp _63_tbop = _source0.dtor_op;
          DAST._IExpression _64_left = _source0.dtor_left;
          DAST._IExpression _65_right = _source0.dtor_right;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.BinOp"), DafnyToSExpressionCompiler.__default.TypedBinOpToSexpr(_63_tbop), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_64_left), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_65_right)));
        }
      }
      {
        if (_source0.is_ArrayLen) {
          DAST._IExpression _66_expr_k = _source0.dtor_expr;
          DAST._IType _67_exprType = _source0.dtor_exprType;
          BigInteger _68_dim = _source0.dtor_dim;
          bool _69_native = _source0.dtor_native;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.ArrayLen"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_66_expr_k), DafnyToSExpressionCompiler.__default.TypeToSexpr(_67_exprType), Std.Strings.__default.OfNat(_68_dim), Std.Strings.__default.OfBool(_69_native)));
        }
      }
      {
        if (_source0.is_MapKeys) {
          DAST._IExpression _70_expr_k = _source0.dtor_expr;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.MapKeys"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_70_expr_k)));
        }
      }
      {
        if (_source0.is_MapValues) {
          DAST._IExpression _71_expr_k = _source0.dtor_expr;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.MapValues"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_71_expr_k)));
        }
      }
      {
        if (_source0.is_MapItems) {
          DAST._IExpression _72_expr_k = _source0.dtor_expr;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.MapItems"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_72_expr_k)));
        }
      }
      {
        if (_source0.is_Select) {
          DAST._IExpression _73_expr_k = _source0.dtor_expr;
          Dafny.ISequence<Dafny.Rune> _74_field = _source0.dtor_field;
          DAST._IFieldMutability _75_fieldMutability = _source0.dtor_fieldMutability;
          DAST._ISelectContext _76_selectContext = _source0.dtor_selectContext;
          DAST._IType _77_fieldType = _source0.dtor_isfieldType;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.Select"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_73_expr_k), DafnyToSExpressionCompiler.__default.VarNameToSexpr(_74_field), DafnyToSExpressionCompiler.__default.FieldMutabilityToSexpr(_75_fieldMutability), DafnyToSExpressionCompiler.__default.SelectContextToSexpr(_76_selectContext), DafnyToSExpressionCompiler.__default.TypeToSexpr(_77_fieldType)));
        }
      }
      {
        if (_source0.is_SelectFn) {
          DAST._IExpression _78_expr_k = _source0.dtor_expr;
          Dafny.ISequence<Dafny.Rune> _79_field = _source0.dtor_field;
          bool _80_onDatatype = _source0.dtor_onDatatype;
          bool _81_isStatic = _source0.dtor_isStatic;
          bool _82_isConstant = _source0.dtor_isConstant;
          Dafny.ISequence<DAST._IType> _83_arguments = _source0.dtor_arguments;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.SelectFn"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_78_expr_k), DafnyToSExpressionCompiler.__default.VarNameToSexpr(_79_field), Std.Strings.__default.OfBool(_80_onDatatype), Std.Strings.__default.OfBool(_81_isStatic), Std.Strings.__default.OfBool(_82_isConstant), DafnyToSExpressionCompiler.__default.MapJoin<DAST._IType>(DafnyToSExpressionCompiler.__default.TypeToSexpr, _83_arguments)));
        }
      }
      {
        if (_source0.is_Index) {
          DAST._IExpression _84_expr_k = _source0.dtor_expr;
          DAST._ICollKind _85_collKind = _source0.dtor_collKind;
          Dafny.ISequence<DAST._IExpression> _86_indices = _source0.dtor_indices;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.Index"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_84_expr_k), DafnyToSExpressionCompiler.__default.CollKindToSexpr(_85_collKind), DafnyToSExpressionCompiler.__default.MapJoinExpressionToSexpr(_86_indices)));
        }
      }
      {
        if (_source0.is_IndexRange) {
          DAST._IExpression _87_expr_k = _source0.dtor_expr;
          bool _88_isArray = _source0.dtor_isArray;
          Std.Wrappers._IOption<DAST._IExpression> _89_low = _source0.dtor_low;
          Std.Wrappers._IOption<DAST._IExpression> _90_high = _source0.dtor_high;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.IndexRange"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_87_expr_k), Std.Strings.__default.OfBool(_88_isArray), DafnyToSExpressionCompiler.__default.OptionToSexpr<DAST._IExpression>(_89_low, Dafny.Helpers.Id<Func<DAST._IExpression, Func<DAST._IExpression, Dafny.ISequence<Dafny.Rune>>>>((_91_expr) => ((System.Func<DAST._IExpression, Dafny.ISequence<Dafny.Rune>>)((_92_x) => {
            return DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_92_x);
          })))(expr)), DafnyToSExpressionCompiler.__default.OptionToSexpr<DAST._IExpression>(_90_high, Dafny.Helpers.Id<Func<DAST._IExpression, Func<DAST._IExpression, Dafny.ISequence<Dafny.Rune>>>>((_93_expr) => ((System.Func<DAST._IExpression, Dafny.ISequence<Dafny.Rune>>)((_94_x) => {
            return DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_94_x);
          })))(expr))));
        }
      }
      {
        if (_source0.is_TupleSelect) {
          DAST._IExpression _95_expr_k = _source0.dtor_expr;
          BigInteger _96_index = _source0.dtor_index;
          BigInteger _97_dim = _source0.dtor_dim;
          DAST._IType _98_fieldType = _source0.dtor_fieldType;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.TupleSelect"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_95_expr_k), Std.Strings.__default.OfNat(_96_index), Std.Strings.__default.OfNat(_97_dim), DafnyToSExpressionCompiler.__default.TypeToSexpr(_98_fieldType)));
        }
      }
      {
        if (_source0.is_Call) {
          DAST._IExpression _99_on = _source0.dtor_on;
          DAST._ICallName _100_callName = _source0.dtor_callName;
          Dafny.ISequence<DAST._IType> _101_typeArgs = _source0.dtor_typeArgs;
          Dafny.ISequence<DAST._IExpression> _102_args = _source0.dtor_args;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.Call"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_99_on), DafnyToSExpressionCompiler.__default.CallNameToSexpr(_100_callName), DafnyToSExpressionCompiler.__default.MapJoin<DAST._IType>(DafnyToSExpressionCompiler.__default.TypeToSexpr, _101_typeArgs), DafnyToSExpressionCompiler.__default.MapJoinExpressionToSexpr(_102_args)));
        }
      }
      {
        if (_source0.is_Lambda) {
          Dafny.ISequence<DAST._IFormal> _103_params = _source0.dtor_params;
          DAST._IType _104_retType = _source0.dtor_retType;
          Dafny.ISequence<DAST._IStatement> _105_body = _source0.dtor_body;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.Lambda"), DafnyToSExpressionCompiler.__default.MapJoin<DAST._IFormal>(DafnyToSExpressionCompiler.__default.FormalToSexpr, _103_params), DafnyToSExpressionCompiler.__default.TypeToSexpr(_104_retType), DafnyToSExpressionCompiler.__default.MapJoinStatementToSexpr(_105_body)));
        }
      }
      {
        if (_source0.is_BetaRedex) {
          Dafny.ISequence<_System._ITuple2<DAST._IFormal, DAST._IExpression>> _106_values = _source0.dtor_values;
          DAST._IType _107_retType = _source0.dtor_retType;
          DAST._IExpression _108_expr_k = _source0.dtor_expr;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.BetaRedex"), DafnyToSExpressionCompiler.__default.MapJoin<_System._ITuple2<DAST._IFormal, DAST._IExpression>>(Dafny.Helpers.Id<Func<Dafny.ISequence<_System._ITuple2<DAST._IFormal, DAST._IExpression>>, DAST._IExpression, Func<_System._ITuple2<DAST._IFormal, DAST._IExpression>, Dafny.ISequence<Dafny.Rune>>>>((_109_values, _110_expr) => ((System.Func<_System._ITuple2<DAST._IFormal, DAST._IExpression>, Dafny.ISequence<Dafny.Rune>>)((_111_x) => {
            return DafnyToSExpressionCompiler.__default.TwoTupleToSexpr<DAST._IFormal, DAST._IExpression>(_111_x, DafnyToSExpressionCompiler.__default.FormalToSexpr, Dafny.Helpers.Id<Func<DAST._IExpression, Func<DAST._IExpression, Dafny.ISequence<Dafny.Rune>>>>((_112_expr) => ((System.Func<DAST._IExpression, Dafny.ISequence<Dafny.Rune>>)((_113_z) => {
              return DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_113_z);
            })))(_110_expr));
          })))(_106_values, expr), _106_values), DafnyToSExpressionCompiler.__default.TypeToSexpr(_107_retType), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_108_expr_k)));
        }
      }
      {
        if (_source0.is_IIFE) {
          Dafny.ISequence<Dafny.Rune> _114_name = _source0.dtor_ident;
          DAST._IType _115_typ = _source0.dtor_typ;
          DAST._IExpression _116_value = _source0.dtor_value;
          DAST._IExpression _117_iifeBody = _source0.dtor_iifeBody;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.IIFE"), DafnyToSExpressionCompiler.__default.VarNameToSexpr(_114_name), DafnyToSExpressionCompiler.__default.TypeToSexpr(_115_typ), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_116_value), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_117_iifeBody)));
        }
      }
      {
        if (_source0.is_Apply) {
          DAST._IExpression _118_expr_k = _source0.dtor_expr;
          Dafny.ISequence<DAST._IExpression> _119_args = _source0.dtor_args;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.Apply"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_118_expr_k), DafnyToSExpressionCompiler.__default.MapJoinExpressionToSexpr(_119_args)));
        }
      }
      {
        if (_source0.is_TypeTest) {
          DAST._IExpression _120_on = _source0.dtor_on;
          Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _121_dType = _source0.dtor_dType;
          Dafny.ISequence<Dafny.Rune> _122_variant = _source0.dtor_variant;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.TypeTest"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_120_on), DafnyToSExpressionCompiler.__default.MapJoin<Dafny.ISequence<Dafny.Rune>>(DafnyToSExpressionCompiler.__default.IdentToSexpr, _121_dType), DafnyToSExpressionCompiler.__default.NameToSexpr(_122_variant)));
        }
      }
      {
        if (_source0.is_Is) {
          DAST._IExpression _123_expr_k = _source0.dtor_expr;
          DAST._IType _124_fromType = _source0.dtor_fromType;
          DAST._IType _125_toType = _source0.dtor_toType;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.Is"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_123_expr_k), DafnyToSExpressionCompiler.__default.TypeToSexpr(_124_fromType), DafnyToSExpressionCompiler.__default.TypeToSexpr(_125_toType)));
        }
      }
      {
        if (_source0.is_InitializationValue) {
          DAST._IType _126_typ = _source0.dtor_typ;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.InitializationValue"), DafnyToSExpressionCompiler.__default.TypeToSexpr(_126_typ)));
        }
      }
      {
      ...
      }
      {
        if (_source0.is_SetBoundedPool) {
          ...
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.SetBoundedPool"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_127_of)));
        }
      }
      {
        if (_source0.is_MapBoundedPool) {
          DAST._IExpression _128_of = _source0.dtor_of;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.MapBoundedPool"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_128_of)));
        }
      }
      {
        if (_source0.is_SeqBoundedPool) {
          ...
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.SeqBoundedPool"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_129_of), Std.Strings.__default.OfBool(_130_includeDuplicates)));
        }
      }
      {
        if (_source0.is_MultisetBoundedPool) {
          DAST._IExpression _131_of = _source0.dtor_of;
          bool _132_includeDuplicates = _source0.dtor_includeDuplicates;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.MultisetBoundedPool"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_131_of), Std.Strings.__default.OfBool(_132_includeDuplicates)));
        }
      }
      {
        if (_source0.is_ExactBoundedPool) {
          DAST._IExpression _133_of = _source0.dtor_of;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.ExactBoundedPool"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_133_of)));
        }
      }
      {
        if (_source0.is_IntRange) {
          DAST._IType _134_elemType = _source0.dtor_elemType;
          DAST._IExpression _135_lo = _source0.dtor_lo;
          DAST._IExpression _136_hi = _source0.dtor_hi;
          bool _137_up = _source0.dtor_up;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.IntRange"), DafnyToSExpressionCompiler.__default.TypeToSexpr(_134_elemType), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_135_lo), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_136_hi), Std.Strings.__default.OfBool(_137_up)));
        }
      }
      {
        if (_source0.is_UnboundedIntRange) {
          DAST._IExpression _138_start = _source0.dtor_start;
          bool _139_up = _source0.dtor_up;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.UnboundedIntRange"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_138_start), Std.Strings.__default.OfBool(_139_up)));
        }
      }
      {
        DAST._IType _140_elemType = _source0.dtor_elemType;
        DAST._IExpression _141_collection = _source0.dtor_collection;
        bool _142_is__forall = _source0.dtor_is__forall;
        DAST._IExpression _143_lambda = _source0.dtor_lambda;
        return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.Quantifier"), DafnyToSExpressionCompiler.__default.TypeToSexpr(_140_elemType), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_141_collection), Std.Strings.__default.OfBool(_142_is__forall), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_143_lambda)));
      }
    }
