...
namespace DafnyToSExpressionCompiler {
  ...
  public partial class __default {
    ...
    public static Dafny.ISequence<Dafny.Rune> ExpressionToSexpr(DAST._IExpression expr) {
      ...
      }
      {
        if (_source0.is_IntRange) {
          DAST._IType _123_elemType = _source0.dtor_elemType;
          DAST._IExpression _124_lo = _source0.dtor_lo;
          DAST._IExpression _125_hi = _source0.dtor_hi;
          bool _126_up = _source0.dtor_up;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.IntRange"), DafnyToSExpressionCompiler.__default.TypeToSexpr(_123_elemType), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_124_lo), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_125_hi), Std.Strings.__default.OfBool(_126_up)));
        }
      }
      {
        if (_source0.is_UnboundedIntRange) {
          DAST._IExpression _127_start = _source0.dtor_start;
          bool _128_up = _source0.dtor_up;
          return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.UnboundedIntRange"), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_127_start), Std.Strings.__default.OfBool(_128_up)));
        }
      }
      {
        DAST._IType _129_elemType = _source0.dtor_elemType;
        DAST._IExpression _130_collection = _source0.dtor_collection;
        bool _131_is__forall = _source0.dtor_is__forall;
        DAST._IExpression _132_lambda = _source0.dtor_lambda;
        return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Expression.Quantifier"), DafnyToSExpressionCompiler.__default.TypeToSexpr(_129_elemType), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_130_collection), Std.Strings.__default.OfBool(_131_is__forall), DafnyToSExpressionCompiler.__default.ExpressionToSexpr(_132_lambda)));
      }
    }
    ...
    public static Dafny.ISequence<Dafny.Rune> MethodToSexpr(DAST._IMethod m) {
      ...
      {
        bool _0_isStatic = _source0.dtor_isStatic;
        bool _1_hasBody = _source0.dtor_hasBody;
        bool _2_outVarsAreUninitFieldsToAssign = _source0.dtor_outVarsAreUninitFieldsToAssign;
        bool _3_wasFunction = _source0.dtor_wasFunction;
        Std.Wrappers._IOption<Dafny.ISequence<Dafny.ISequence<Dafny.Rune>>> _4_overridingPath = _source0.dtor_overridingPath;
        Dafny.ISequence<Dafny.Rune> _5_name = _source0.dtor_name;
        Dafny.ISequence<DAST._ITypeArgDecl> _6_typeParams = _source0.dtor_typeParams;
        Dafny.ISequence<DAST._IFormal> _7_params = _source0.dtor_params;
        Dafny.ISequence<DAST._IStatement> _8_body = _source0.dtor_body;
        Dafny.ISequence<DAST._IType> _9_outTypes = _source0.dtor_outTypes;
        Std.Wrappers._IOption<Dafny.ISequence<Dafny.ISequence<Dafny.Rune>>> _10_outVars = _source0.dtor_outVars;
        return DafnyToSExpressionCompiler.__default.StringSeqToSexpr(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Method.Method"), Std.Strings.__default.OfBool(_0_isStatic), Std.Strings.__default.OfBool(_1_hasBody), Std.Strings.__default.OfBool(_2_outVarsAreUninitFieldsToAssign), Std.Strings.__default.OfBool(_3_wasFunction), DafnyToSExpressionCompiler.__default.OptionToSexpr<Dafny.ISequence<Dafny.ISequence<Dafny.Rune>>>(_4_overridingPath, ((System.Func<Dafny.ISequence<Dafny.ISequence<Dafny.Rune>>, Dafny.ISequence<Dafny.Rune>>)((_11_x) => {
          return DafnyToSExpressionCompiler.__default.MapJoin<Dafny.ISequence<Dafny.Rune>>(DafnyToSExpressionCompiler.__default.IdentToSexpr, _11_x);
        }))), DafnyToSExpressionCompiler.__default.NameToSexpr(_5_name), DafnyToSExpressionCompiler.__default.MapJoin<DAST._ITypeArgDecl>(DafnyToSExpressionCompiler.__default.TypeArgDeclToSexpr, _6_typeParams), DafnyToSExpressionCompiler.__default.MapJoin<DAST._IFormal>(DafnyToSExpressionCompiler.__default.FormalToSexpr, _7_params), DafnyToSExpressionCompiler.__default.MapJoin<DAST._IStatement>(DafnyToSExpressionCompiler.__default.StatementToSexpr, _8_body), DafnyToSExpressionCompiler.__default.MapJoin<DAST._IType>(DafnyToSExpressionCompiler.__default.TypeToSexpr, _9_outTypes), DafnyToSExpressionCompiler.__default.OptionToSexpr<Dafny.ISequence<Dafny.ISequence<Dafny.Rune>>>(_10_outVars, ((System.Func<Dafny.ISequence<Dafny.ISequence<Dafny.Rune>>, Dafny.ISequence<Dafny.Rune>>)((_12_x) => {
          return DafnyToSExpressionCompiler.__default.MapJoin<Dafny.ISequence<Dafny.Rune>>(DafnyToSExpressionCompiler.__default.VarNameToSexpr, _12_x);
        })))));
      }
    }
