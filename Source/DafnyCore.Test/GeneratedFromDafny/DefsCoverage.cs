...
namespace DefsCoverage {
  ...
  public partial class __default {
    ...
    public static void Tests()
    {
      ...
      DefsCoverage.__default.Expect(object.Equals(Defs.__default.DetectAssignmentStatus(Dafny.Sequence<DAST._IStatement>.Concat(Dafny.Sequence<DAST._IStatement>.FromElements(DAST.Statement.create_Print(_2_z, DAST.Type.create_Tuple(Dafny.Sequence<DAST._IType>.FromElements()))), _3_assigns__x), _0_x), Defs.AssignmentStatus.create_SurelyAssigned()));
      DefsCoverage.__default.Expect(object.Equals(Defs.__default.DetectAssignmentStatus(Dafny.Sequence<DAST._IStatement>.Concat(Dafny.Sequence<DAST._IStatement>.FromElements(DAST.Statement.create_Print(_2_z, DAST.Type.create_Tuple(Dafny.Sequence<DAST._IType>.FromElements()))), _3_assigns__x), _0_x), Defs.AssignmentStatus.create_SurelyAssigned()));
